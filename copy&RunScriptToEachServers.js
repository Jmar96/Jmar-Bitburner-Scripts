          ...
          for (let taskName of taskNames) {
            ...
            if (p >= portsRequired) {
              ...
              if (!ns.fileExists(taskName, serv)) {
                ...
                ns.tprint("WARN::Script Exist (wont create) | Threads available: " + threadCount + " | " + serv);
              }
            } else {
              ns.tprint("ERROR::Ports opened [" + p + "] vs Ports required [" + portsRequired + "])| (wont create) | Threads available: " + threadCount + " | " + serv);
            }
            await ns.sleep(700);
          }
