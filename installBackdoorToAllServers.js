...
//   // path = ["home","harakiri-sushi","max-hardware","omega- net","the-hub", "I.I.I.I"]
//   let path = dpList(ns);
//   path.forEach(hop => ns.connect(hop))
//   ns.installBackdoor();
// }
/** @param {NS} ns */
export async function main(ns) {
    ...
    ns.tprint("INFOR::|homePaths: " + homePaths);
    ns.tprint("ERROR::|homePath: " + homePath);
